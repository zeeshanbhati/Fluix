...
class _PreviewCodeState extends State<PreviewCode> {
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text("FLUIX", style: TextStyle(color: enableDarkMode ? Colors.teal[300] : Colors.blue[600]),),
          actions: <Widget>[
        ...
        bottom: TabBar(
          tabs: <Widget>[
            Tab(
              child: Text("Code", style: TextStyle(color: enableDarkMode ? Colors.grey : Colors.black54),),
              icon: Icon(Icons.code, color: enableDarkMode ? Colors.grey : Colors.black54),
            ),
            Tab(
              child: Text("Preview", style: TextStyle(color: enableDarkMode ? Colors.grey : Colors.black54),),
              icon: Icon(Icons.phone_android, color: enableDarkMode ? Colors.grey : Colors.black54),
            ),
          ]
        ),
        ),
