    ...
    return Scaffold(
      ...
      body: Container(
        decoration: BoxDecoration(
          boxShadow: [BoxShadow(spreadRadius: 2, blurRadius: 6, color: Colors.black.withOpacity(0/1))]
        ),
              ...
              return NotificationListener<ScrollNotification>(
                ...
                child: ListView.separated(
                  ...
                  itemBuilder: (context, index) => GestureDetector(
                    onTap: () {Navigator.of(context).push(MaterialPageRoute(builder: (context) => TypeList(type: uiNames[index])));},
                    child: dashboardCard(uiNames[index], homeimgs[index], context),
                  ),
                ),
              );
            },
