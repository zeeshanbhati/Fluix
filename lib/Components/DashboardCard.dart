  ...
  return Padding(
    ...
    child: TweenAnimationBuilder(
      ...
      builder: (_, double rotation, child) {
        return Transform(
          transform: Matrix4.identity() ..setEntry(3, 2, 0.1) ..rotateZ(rotation),
          ...
          child: Container(
            ...
            child: Card(
              ...
              shape: RoundedRectangleBorder(
                side: BorderSide(color: enableDarkMode ? Colors.teal[200] : Colors.black, width: 5,),
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Positioned(
                    ...
                    child: BorderedText(
                      strokeWidth: 5,
                      strokeColor: enableDarkMode ? Colors.white.withOpacity(0.75) : Colors.black,
                      child: Text(text, style: TextStyle(color: enableDarkMode ? Colors.black : Colors.white, fontSize: 30, fontFamily: "Dosis",),),
                    ),
                  )
                ],
              ),
